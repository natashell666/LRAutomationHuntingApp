...
# Function to get the Cortex Analyzers
function Get-Analyzers
{
	...
	$output = Invoke-Process -FilePath $execPath -ArgumentList "$cortexPath --cortex_url $global:CortexURL --cortex_key $global:CortexAPIKey analyzers"
    Write-Output $output
}
